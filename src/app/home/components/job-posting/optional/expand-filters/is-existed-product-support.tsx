...
const IsExistedProductSupport = () => {
  ...
  const selectedOption =
    getJobPostingFilterQuery("isExistedProductSupport") || "상관없음";

  const handleSelect = (selectedOption: string | null) => {
    selectedOption = selectedOption === "상관없음" ? null : selectedOption;
    if (selectedOption) {
      addJobPostingFilterQuery(`isExistedProductSupport=${selectedOption}`);
    } else {
      removeJobPostingFilterQuery("isExistedProductSupport");
    }
  };
...
export default IsExistedProductSupport;

...
const IsExistedTowelSupplier = () => {
  ...
  const selectedOption =
    getJobPostingFilterQuery("isExistedTowelSupplier") || "상관없음";

  const handleSelect = (selectedOption: string | null) => {
    selectedOption = selectedOption === "상관없음" ? null : selectedOption;
    if (selectedOption) {
      addJobPostingFilterQuery(`isExistedTowelSupplier=${selectedOption}`);
    } else {
      removeJobPostingFilterQuery("isExistedTowelSupplier");
    }
  };
...
export default IsExistedTowelSupplier;

...
import DetailStoreEtcInfoDesigner from "../components/DetailStoreEtcInfoDesigner";
import DetailStoreEtcInfoIntern from "../components/DetailStoreEtcInfoIntern";
import DetailStoreInfoDesigner from "../components/DetailStoreInfoDesigner";
import DetailStoreInfoIntern from "../components/DetailStoreInfoIntern";
...
export default function PageContent({
  ...
  useEffect(() => {
    const handleJobPostingView = async () => {
      ...
      const timestampKey = `jobPostingViewTimestamp_${initialJobPosting.id}`;
